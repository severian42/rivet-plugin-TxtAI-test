...
class PipelineRun {
    ...
    submit({ waitForServer } = { waitForServer: false }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const coreApi$1 = new coreApi.CoreApi(this.pipeline.config);
            this.pipeline.logInfo("Submitting PipelineRun to Gentrace");
            const submission = coreApi$1.runPost({
                id: this.id,
                slug: this.pipeline.slug,
                collectionMethod: runRequest.RunRequestCollectionMethodEnum.Runner,
                stepRuns: this.stepRuns.map(({ provider: providerName, elapsedTime, startTime, endTime, invocation, modelParams, inputs, outputs, context: stepRunContext, }) => {
                    var _a;
                    return {
                        providerName,
                        elapsedTime,
                        ...
                        inputs,
                        outputs,
                        context: Object.assign(Object.assign({}, ((_a = this.context) !== null && _a !== void 0 ? _a : {})), (stepRunContext !== null && stepRunContext !== void 0 ? stepRunContext : {})),
                    };
                }),
            });
            if (!waitForServer) {
