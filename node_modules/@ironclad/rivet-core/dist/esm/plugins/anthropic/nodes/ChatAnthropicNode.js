import { addWarning, coerceType, coerceTypeOptional, expectTypeOptional, getError, getScalarTypeOf, getTokenCountForString, isArrayDataValue, pluginNodeDefinition, } from '@ironclad/rivet-core';
    ...
    async process(data, inputs, context) {
        ...
        try {
            return await retry(async () => {
                ...
                const responseTokenCount = getTokenCountForString(responseParts.join(''), anthropicModels[model].tiktokenModel);
