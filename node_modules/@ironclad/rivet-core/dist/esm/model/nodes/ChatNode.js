...
import { getCostForPrompt, getCostForTokens, getTokenCountForMessages, getTokenCountForString, } from '../../utils/tokenizer.js';
import { addWarning } from '../../utils/outputs.js';
import { DEFAULT_CHAT_ENDPOINT, OpenAIError, openAiModelOptions, openaiModels, streamChatCompletions, } from '../../utils/openai.js';
import retry from 'p-retry';
import { match } from 'ts-pattern';
import { coerceType, coerceTypeOptional } from '../../utils/coerceType.js';
import { getError, getInputOrData } from '../../index.js';
    ...
    async process(inputs, context) {
        ...
        try {
            return await retry(async () => {
                ...
                const cost = getCostForPrompt(completionMessages, model) +
                    getCostForTokens(responseTokenCount, 'completion', model);
