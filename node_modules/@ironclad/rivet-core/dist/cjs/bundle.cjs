...
__export(src_exports, {
  ...
  dedent: () => import_ts_dedent64.dedent,
  delayNode: () => delayNode,
...
var PluginNodeImplClass = class extends NodeImpl2 {
  impl;
...
var UserInputNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "userInput",
      title: "User Input",
  ...
  getOutputValuesFromUserInput(questions, answers) {
    ...
    return {
      ...
      ["questionsAndAnswers"]: {
        type: "string[]",
        value: (0, import_lodash_es.zip)(questionsList, answers.value).map(([q, a]) => `${q}
${a}`)
      }
    };
  }
...
var TextNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "text",
      title: "Text",
...
async function* streamChatCompletions({
  ...
  const timeout = endpoint === DEFAULT_CHAT_ENDPOINT ? 5e3 : 1e7;
...
var ChatNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "chat",
      title: "Chat",
    ...
    try {
      return await (0, import_p_retry.default)(
        async () => {
          ...
          const responseTokenCount = responseChoicesParts.map((choiceParts) => getTokenCountForString(choiceParts.join(), openaiModel.tiktokenModel)).reduce((a, b) => a + b, 0);
          ...
          output["__hidden_token_count"] = { type: "number", value: requestTokenCount + responseTokenCount };
...
var PromptNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "prompt",
      title: "Prompt",
  ...
  async process(inputs) {
    const inputMap = (0, import_lodash_es2.mapValues)(inputs, (input) => coerceType(input, "string"));
...
var ExtractRegexNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "extractRegex",
      title: "Extract Regex",
...
var CodeNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "code",
      title: "Code",
      ...
      data: {
        code: import_ts_dedent6.dedent`// This is a code node, you can write and JS in here and it will be executed.
...
var MatchNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "match",
      title: "Match",
...
var IfNodeImpl = class extends NodeImpl2 {
  static create = () => {
    const chartNode = {
      type: "if",
      title: "If",
...
var ReadDirectoryNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
...
var ReadFileNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
...
var IfElseNodeImpl = class extends NodeImpl2 {
  static create = () => {
    const chartNode = {
      type: "ifElse",
      title: "If/Else",
...
var ChunkNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "chunk",
      title: "Chunk",
...
var GraphInputNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "graphInput",
      title: "Graph Input",
...
var GraphOutputNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "graphOutput",
      title: "Graph Output",
...
var SubGraphNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "subGraph",
      title: "Subgraph",
...
var ArrayNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "array",
      title: "Array",
          ...
          if (Array.isArray(input == null ? void 0 : input.value)) {
            for (const value of (input == null ? void 0 : input.value) ?? []) {
              if (this.data.flattenDeep) {
                outputArray.push(...Array.isArray(value) ? (0, import_lodash_es3.flattenDeep)(value) : [value]);
              } else {
...
var ExtractJsonNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "extractJson",
      title: "Extract JSON",
...
var AssemblePromptNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "assemblePrompt",
  ...
  async process(inputs) {
    const output = {};
    const outMessages = [];
    const inputMessages = (0, import_lodash_es4.orderBy)(
...
var ExtractYamlNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "extractYaml",
      title: "Extract YAML",
...
var LoopControllerNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "loopController",
...
var TrimChatMessagesNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
...
var ExternalCallNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
  ...
  async process(inputs, context) {
    ...
    const externalContext = (0, import_lodash_es5.omit)(context, ["setGlobal"]);
    if (!fn) {
      if (this.data.useErrorOutput) {
        return {
          ["result"]: {
...
var ExtractObjectPathNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
...
var RaiseEventNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
...
var ContextNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "context",
      title: "Context",
...
var CoalesceNodeImpl = class extends NodeImpl2 {
  static create = () => {
    const chartNode = {
      type: "coalesce",
      title: "Coalesce",
...
var PassthroughNodeImpl = class extends NodeImpl2 {
  static create = () => {
    const chartNode = {
      type: "passthrough",
      title: "Passthrough",
...
var PopNodeImpl = class extends NodeImpl2 {
  static create() {
    const baseNode = {
      type: "pop",
      title: "Pop",
...
var SetGlobalNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "setGlobal",
      title: "Set Global",
...
var GetGlobalNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "getGlobal",
      title: "Get Global",
...
var WaitForEventNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
...
var GptFunctionNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "gptFunction",
      title: "GPT Function",
...
var ToYamlNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "toYaml",
      title: "To YAML",
...
var GetEmbeddingNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
...
var VectorStoreNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
...
var VectorNearestNeighborsNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
...
var HashNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "hash",
      title: "Hash",
...
var AbortGraphNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "abortGraph",
      title: "Abort Graph",
...
var RaceInputsNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "raceInputs",
      title: "Race Inputs",
...
var ToJsonNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "toJson",
      title: "To JSON",
...
var JoinNodeImpl = class extends NodeImpl2 {
  static create = () => {
    const chartNode = {
      type: "join",
      title: "Join",
...
var FilterNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "filter",
      title: "Filter",
  ...
  async process(inputs) {
    ...
    const zipped = (0, import_lodash_es6.zip)(array, include);
...
var ObjectNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "object",
      title: "Object",
...
var BooleanNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "boolean",
      title: "Bool",
...
var CompareNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "compare",
      title: "Compare",
  ...
  async process(inputs) {
    ...
    return {
      ["output"]: {
        type: "boolean",
        value: (0, import_ts_pattern4.match)(comparisonFunction).with("==", () => (0, import_lodash_es7.isEqual)(value1, value2)).with("!=", () => !(0, import_lodash_es7.isEqual)(value1, value2)).with("<", () => value1 < value2).with(">", () => value1 > value2).with("<=", () => value1 <= value2).with(">=", () => value1 >= value2).with("and", () => !!(value1 && value2)).with("or", () => !!(value1 || value2)).with("xor", () => !!(value1 ? !value2 : value2)).with("nand", () => !(value1 && value2)).with("nor", () => !(value1 || value2)).with("xnor", () => !(value1 ? !value2 : value2)).exhaustive()
      }
    };
  }
};
...
var EvaluateNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "evaluate",
      title: "Evaluate",
...
var NumberNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "number",
      title: "Number",
...
var RandomNumberNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "randomNumber",
      title: "RNG",
...
var ShuffleNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "shuffle",
      title: "Shuffle",
  ...
  async process(inputs) {
    ...
    const shuffled = (0, import_lodash_es8.shuffle)(items);
    return {
      ["shuffled"]: {
        type: ((_a = inputs["array"]) == null ? void 0 : _a.type) ?? "any[]",
        value: shuffled
...
var CommentNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "comment",
      title: "Comment",
...
var ImageNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
...
var AudioNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
...
var HttpCallNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "httpCall",
      title: "Http Call",
  ...
  getBody() {
    return import_ts_dedent51.dedent`
...
var DelayNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "delay",
      title: "Delay",
...
var AppendToDatasetNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
...
var CreateDatasetNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
      id: newId(),
      type: "createDataset",
...
var LoadDatasetNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
      id: newId(),
      type: "loadDataset",
...
var GetAllDatasetsNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
      id: newId(),
      type: "getAllDatasets",
...
var SplitNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
      id: newId(),
      type: "split",
...
var DatasetNearestNeighborsNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
      id: newId(),
...
// src/model/nodes/GetDatasetRow.ts
var GetDatasetRowNodeImpl = class extends NodeImpl2 {
  static create() {
    return {
      id: newId(),
      type: "getDatasetRow",
...
var SliceNodeImpl = class extends NodeImpl2 {
  static create() {
    const chartNode = {
      type: "slice",
      title: "Slice",
...
var GraphProcessor = class _GraphProcessor {
  ...
  async #processNodeIfAllInputsAvailable(node) {
    ...
    if (this.#excludedDueToControlFlow(node, inputValues, (0, import_non_secure58.nanoid)(), "loop-not-broken")) {
  ...
  async #processNode(node) {
    const processId = (0, import_non_secure58.nanoid)();
    const builtInNode = node;
  ...
  async #processSplitRunNode(node, processId) {
    ...
    const splittingAmount = Math.min(
      (0, import_lodash_es9.max)(values(inputValues).map((value) => Array.isArray(value == null ? void 0 : value.value) ? value == null ? void 0 : value.value.length : 1)) ?? 1,
      node.splitRunMax ?? 10
    );
    this.#emitter.emit("nodeStart", { node, inputs: inputValues, processId });
    try {
      ...
      if (node.isSplitSequential) {
        ...
        results = await Promise.all(
          (0, import_lodash_es9.range)(0, splittingAmount).map(async (i) => {
            var _a2;
            const inputs = fromEntries(
              entries(inputValues).map(([port, value]) => [
                port,
      ...
      this.#visitedNodes.add(node.id);
      this.#totalCost += (0, import_lodash_es9.sum)(results.map((r) => {
        var _a2;
  ...
  #outputNodesFrom(node) {
    ...
    const outputNodes = (0, import_lodash_es9.uniqBy)(
...
var yaml6 = __toESM(require("yaml"), 1);
...
function fromSerializedProject(serializedProject) {
  return {
    ...
    graphs: (0, import_lodash_es10.mapValues)(serializedProject.graphs, (graph) => fromSerializedGraph(graph)),
    plugins: []
  };
}
...
function graphV4Deserializer(data) {
  ...
  const serializedGraph = yaml4.parse(data);
...
function projectV4Serializer(project, attachedData) {
  ...
  const serialized = yaml4.stringify(
    {
      version: 4,
      data: stabilized
    },
...
function toSerializedProject(project, attachedData) {
  return {
    ...
    graphs: (0, import_lodash_es11.mapValues)(project.graphs, (graph) => toSerializedGraph(graph)),
    attachedData,
...
function fromSerializedProject2(serializedProject) {
  return [
    {
      metadata: serializedProject.metadata,
      graphs: (0, import_lodash_es11.mapValues)(serializedProject.graphs, (graph) => fromSerializedGraph2(graph)),
...
function toSerializedNode(node, allNodes, allConnections) {
  ...
  return {
    ...
    variants: (((_b = node.variants) == null ? void 0 : _b.length) ?? 0) > 0 ? node.variants : void 0
  };
}
...
var yaml5 = __toESM(require("yaml"), 1);
...
var ExecutionRecorder = class _ExecutionRecorder {
  ...
  constructor(options2 = {}) {
    ...
    this.#emitter = new import_emittery2.default();
  ...
  recordSocket(channel) {
    return new Promise((resolve, reject) => {
      this.recordingId = (0, import_non_secure60.nanoid)();
...
var ChatAnthropicNodeImpl = {
  ...
  async process(data, inputs, context) {
    const output = {};
    const rawModel = data.useModelInput ? (0, import_rivet_core.coerceTypeOptional)(inputs["model"], "string") ?? data.model : data.model;
    const model = rawModel;
    const temperature = data.useTemperatureInput ? (0, import_rivet_core.coerceTypeOptional)(inputs["temperature"], "number") ?? data.temperature : data.temperature;
    const topP = data.useTopPInput ? (0, import_rivet_core.coerceTypeOptional)(inputs["top_p"], "number") ?? data.top_p : data.top_p;
    const useTopP = data.useUseTopPInput ? (0, import_rivet_core.coerceTypeOptional)(inputs["useTopP"], "boolean") ?? data.useTopP : data.useTopP;
    const stop = data.useStopInput ? data.useStop ? (0, import_rivet_core.coerceTypeOptional)(inputs["stop"], "string") ?? data.stop : void 0 : data.stop;
    const functions = (0, import_rivet_core.expectTypeOptional)(inputs["functions"], "gpt-function[]");
...
Assistant: ${message.message}`;
    ...
    prompt += "\n\nAssistant:";
    let { maxTokens } = data;
    const tokenCount = (0, import_rivet_core.getTokenCountForString)(prompt, anthropicModels[model].tiktokenModel);
    ...
    if (tokenCount + maxTokens > anthropicModels[model].maxTokens) {
      ...
      (0, import_rivet_core.addWarning)(output, message);
    ...
    try {
      return await (0, import_p_retry2.default)(
        async () => {
          ...
          const requestTokenCount = (0, import_rivet_core.getTokenCountForString)(prompt, anthropicModels[model].tiktokenModel);
          output["requestTokens"] = { type: "number", value: requestTokenCount };
          const responseTokenCount = (0, import_rivet_core.getTokenCountForString)(
            responseParts.join(""),
      ...
      context.trace((0, import_rivet_core.getError)(error).stack ?? "Missing stack");
      throw new Error(`Error processing ChatAnthropicNode: ${error.message}`);
    }
  }
};
var chatAnthropicNode = (0, import_rivet_core.pluginNodeDefinition)(ChatAnthropicNodeImpl, "Chat");
function getChatAnthropicNodeMessages(inputs) {
  ...
  const messages = (0, import_ts_pattern7.match)(prompt).with({ type: "chat-message" }, (p) => [p.value]).with({ type: "chat-message[]" }, (p) => p.value).with({ type: "string" }, (p) => [
    ...
    if ((0, import_rivet_core.isArrayDataValue)(p)) {
      const stringValues = p.value.map(
        (v) => (0, import_rivet_core.coerceType)(
          {
            type: (0, import_rivet_core.getScalarTypeOf)(p.type),
            value: v
          },
          "string"
        )
    ...
    const coercedMessage = (0, import_rivet_core.coerceType)(p, "chat-message");
    if (coercedMessage != null) {
      return [coercedMessage];
    }
    const coercedString = (0, import_rivet_core.coerceType)(p, "string");
    return coercedString != null ? [{ type: "user", message: (0, import_rivet_core.coerceType)(p, "string"), function_call: void 0, name: void 0 }] : [];
  });
  return { messages };
}
...
var LemurQaNodeImpl = {
  ...
  getUIData() {
    return {
      infoBoxBody: import_ts_dedent57.dedent`Use AssemblyAI LeMUR to ask questions about transcripts`,
...
async function runLemurQa(apiToken, params) {
...
var TranscribeAudioNodeImpl = {
  ...
  getUIData() {
    return {
      infoBoxBody: import_ts_dedent58.dedent`Use AssemblyAI to transcribe audio`,
...
var LemurSummaryNodeImpl = {
  ...
  getUIData() {
    return {
      infoBoxBody: import_ts_dedent59.dedent`Use AssemblyAI LeMUR Summary to summarize transcripts`,
...
var LemurTaskNodeImpl = {
  ...
  getUIData() {
    return {
      infoBoxBody: import_ts_dedent60.dedent`Use AssemblyAI LeMUR Custom Task to ask anything.`,
...
var LemurActionItemsNodeImpl = {
  ...
  getUIData() {
    return {
      infoBoxBody: import_ts_dedent61.dedent`Use AssemblyAI LeMUR Action Items to extract action items`,
...
async function runLemurActionItems(apiToken, params) {
...
var PineconeVectorDatabase = class {
  ...
  async store(collection, vector, data, { id }) {
    const collectionDetails = getCollection((0, import_rivet_core2.coerceType)(collection, "string"));
    if (!id) {
