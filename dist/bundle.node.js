...
var rewriteNodeEntryPlugin = {
  name: "rewrite-node-entry",
  setup(build2) {
    build2.onResolve({ filter: /\/nodeEntry$/ }, (args) => {
      return {
        external: true,
...
var nodeBundleOptions = {
  entryPoints: ["src/nodeEntry.cjs"],
  // Updated to cjs since it's now a CommonJS file
  bundle: true,
  platform: "node",
  target: "es2020",
